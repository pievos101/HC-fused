...
#mRNA
mRNAX  <- t(read.table("~/TCGA_data/NAR Data/breast/exp"))

#Methy 
MethyX <- t(read.table("~/TCGA_data/NAR Data/breast/methy"))

#miRNA 
miRNAX <- t(read.table("~/TCGA_data/NAR Data/breast/mirna"))

#CLIN
survivalX <- read.table("~/TCGA_data/NAR Data/breast/survival", header=TRUE)
...
## HCfused
res        <- HC_fused_subtyping(list(mRNA,Methy,miRNA), max.k=10, HC.iter=20)
